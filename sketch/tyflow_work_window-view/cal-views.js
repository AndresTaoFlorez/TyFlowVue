...
const {
  ...
  fmtHour, layoutColumns, splitDay, buildMonthGrid,
...
const DayColumn = {
  ...
  computed: {
    laid() { return layoutColumns(this.windows); },
...
const WeekView = {
  ...
  methods: {
    ...
    headCls(i) {
      return ['cal-head__day', i === this.todayIndex && 'cal-head__day--today', i >= 5 && 'cal-head__day--weekend'].filter(Boolean);
    },
  },
  ...
  template: `
    <div class="cal">
      <div class="cal-head" :style="{ gridTemplateColumns: gridTemplate }">
        ...
        <div v-for="(iso, i) in weekDates" :key="iso" :class="headCls(i)">
...
const DayView = {
  ...
  template: `
    <div class="cal">
      <div class="cal-head" :style="{ gridTemplateColumns: gridTemplate }">
        <div class="cal-head__gutter"></div>
        <div :class="['cal-head__day', isToday && 'cal-head__day--today', dayIndex >= 5 && 'cal-head__day--weekend']" style="flex-direction:row;gap:0.6rem">
